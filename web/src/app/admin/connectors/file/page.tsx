  ...
  return (
    <div>
      ...
      <Text className="mb-2">
        ...
        these files will be searchable via VTRC AI Assistant! Currently only <i>.txt</i>,{" "}
      ...
      <Text className="mb-3">
        ...
        VTRC AI Assistant to link users to the original document when they click on the
