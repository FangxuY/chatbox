...
export const DriveOAuthSection = ({
  ...
  if (serviceAccountKeyData?.service_account_email) {
    return (
      <div>
        <p className="text-sm mb-2">
          When using a Google Drive Service Account, you can either have VTRC AI Assistant
            ...
            {({ isSubmitting }) => (
              <Form>
                <TextFormField
                  ...
                  subtext="If left blank, VTRC AI Assistant will use the service account itself."
                />
                <div className="flex">
                  <button
                    type="submit"
